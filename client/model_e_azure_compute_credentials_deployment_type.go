...
// EAzureComputeCredentialsDeploymentType the model 'EAzureComputeCredentialsDeploymentType'
...
func (v *EAzureComputeCredentialsDeploymentType) UnmarshalJSON(src []byte) error {
	...
	for _, existing := range []EAzureComputeCredentialsDeploymentType{ "MicrosoftAzure", "MicrosoftAzureStack",   } {
