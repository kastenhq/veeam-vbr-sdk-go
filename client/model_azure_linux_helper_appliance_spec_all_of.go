...
// AzureLinuxHelperApplianceSpecAllOf Azure linux restore helper appliance spec.
type AzureLinuxHelperApplianceSpecAllOf struct {
...
func NewAzureLinuxHelperApplianceSpecAllOf(subscriptionId string, ) *AzureLinuxHelperApplianceSpecAllOf {
	this := AzureLinuxHelperApplianceSpecAllOf{}
...
func (o AzureLinuxHelperApplianceSpecAllOf) MarshalJSON() ([]byte, error) {
...
type NullableAzureLinuxHelperApplianceSpecAllOf struct {
	value *AzureLinuxHelperApplianceSpecAllOf
	isSet bool
}

func (v NullableAzureLinuxHelperApplianceSpecAllOf) Get() *AzureLinuxHelperApplianceSpecAllOf {
	return v.value
}

func (v *NullableAzureLinuxHelperApplianceSpecAllOf) Set(val *AzureLinuxHelperApplianceSpecAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableAzureLinuxHelperApplianceSpecAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableAzureLinuxHelperApplianceSpecAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAzureLinuxHelperApplianceSpecAllOf(val *AzureLinuxHelperApplianceSpecAllOf) *NullableAzureLinuxHelperApplianceSpecAllOf {
	return &NullableAzureLinuxHelperApplianceSpecAllOf{value: val, isSet: true}
}

func (v NullableAzureLinuxHelperApplianceSpecAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAzureLinuxHelperApplianceSpecAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
