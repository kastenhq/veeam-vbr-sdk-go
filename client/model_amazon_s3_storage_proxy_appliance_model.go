...
// AmazonS3StorageProxyApplianceModel Amazon S3 Glacier proxy appliance.
...
func (o *AmazonS3StorageProxyApplianceModel) GetEc2InstanceType() string {
	if o == nil || o.Ec2InstanceType == nil {
		var ret string
		return ret
	}
