...
// InstantViVMRecoverySpec struct for InstantViVMRecoverySpec
type InstantViVMRecoverySpec struct {
	...
	// If *true*, Veeam Backup & Replication will restore tags that were assigned to the original VMs, and assign them to the restored VM.
	VmTagsRestoreEnabled *bool `json:"VmTagsRestoreEnabled,omitempty"`
	SecureRestore SecureRestoreSpec `json:"secureRestore"`
	// If *true*, the restored VMs will be connected to the network.
	NicsEnabled *bool `json:"nicsEnabled,omitempty"`
	// If *true*, Veeam Backup & Replication will start the restored VMs on the target host.
	PowerUp *bool `json:"powerUp,omitempty"`
	// Reason for restoring the VMs.
...
func (o *InstantViVMRecoverySpec) GetVmTagsRestoreEnabled() bool {
	if o == nil || o.VmTagsRestoreEnabled == nil {
		var ret bool
		return ret
	}
