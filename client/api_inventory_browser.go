...
func (r ApiTestVmwareHostObjectRequest) Execute() (map[string]interface{}, *_nethttp.Response, error) {
 ...
 */
func (a *InventoryBrowserApiService) TestVmwareHostObject(ctx _context.Context, name string) ApiTestVmwareHostObjectRequest {
	return ApiTestVmwareHostObjectRequest{
		ApiService: a,
		ctx: ctx,
		name: name,
 ...
 */
func (a *InventoryBrowserApiService) TestVmwareHostObjectExecute(r ApiTestVmwareHostObjectRequest) (map[string]interface{}, *_nethttp.Response, error) {
	var (
